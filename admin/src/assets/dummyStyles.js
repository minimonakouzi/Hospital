...
export const doctorDetailStyles = {
  // Layout styles
  pageContainer: "min-h- font-serif bg-linear-to-br from-blue-50 via-white to-sky-50 p-4 sm:p-6",
  ...
  headerTitle: "text-3xl sm:text-4xl md:text-5xl font-bold bg-linear-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent mt-2 sm:mt-0",
  
  // Form styles
  formContainer: "bg-white/80 backdrop-blur-sm border border-blue-100 shadow-2xl p-6 sm:p-8 rounded-3xl mb-16",
  formGrid: "grid grid-cols-1 md:grid-cols-2 gap-6",
  
  // Input styles
  inputBase: "p-3 rounded-full border-2 border-blue-100 bg-white placeholder:text-gray-400 shadow-sm w-full focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 transition-all",
  ...
  scheduleContainer: "p-6 bg-blue-50 rounded-2xl border border-blue-100",
  ...
  scheduleDateInput: "p-3 rounded-full border-2 border-blue-100 w-full sm:w-auto",
  scheduleTimeSelect: "p-3 rounded-full border-2 border-blue-100 w-full sm:w-auto",
  ...
  slotItem: "flex justify-between items-center bg-blue-50 p-3 rounded-xl border border-blue-100 shadow-sm hover:shadow-md text-blue-800",
  ...
  submitButtonEnabled: "bg-linear-to-r from-blue-500 to-cyan-500 text-white",
...
export const pageStyles = {
  container: "min-h-screen font-serif bg-blue-50 p-3 sm:p-4 md:p-6 lg:p-8",
  ...
  headerTitle: "text-xl sm:text-2xl font-semibold text-blue-800",
  headerSubtitle: "text-xs sm:text-sm text-blue-600",
  ...
  searchInput: "ml-3 w-full outline-none text-blue-700 placeholder-blue-400 bg-transparent text-sm",
  ...
  selectFilter: "text-sm px-3 py-2 cursor-pointer rounded-full bg-blue-100 shadow-sm outline-blue-300 w-full sm:w-auto",
  ...
  loadingErrorContainer: "col-span-full text-center text-blue-600 py-12 rounded-lg bg-white/60 border border-blue-100",
  errorContainer: "col-span-full text-center text-rose-600 py-6 rounded-lg bg-white/60 border border-rose-100",
  noResultsContainer: "col-span-full text-center text-blue-600 py-12 rounded-lg bg-white/60 border border-blue-100",
  
  gridContainer: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4",
  
  card: "bg-white rounded-2xl p-3 sm:p-4 md:p-5 shadow-sm border border-blue-100 flex flex-col gap-3 hover:shadow-md transform hover:-translate-y-1 transition",
  cardHeader: "flex items-start lg:line-clamp-2 justify-between gap-3",
  cardTitle: "text-base sm:text-lg font-medium text-blue-800 truncate",
  patientInfo: "text-xs sm:text-sm text-blue-500 flex items-center gap-2",
  doctorInfo: "mt-1 text-xs sm:text-sm text-blue-600 truncate",
  ...
  feeAmount: "text-lg sm:text-xl font-semibold lg:justify-start text-blue-800 flex items-center justify-end gap-1",
  ...
  showMoreButton: "px-4 py-2 cursor-pointer rounded-full bg-white border border-blue-200 shadow-sm hover:shadow-md transition",
};
...
export const dashboardStyles = {
  // Layout styles
  pageContainer: "min-h-screen font-serif p-4 sm:p-6 bg-linear-to-br from-sky-50 via-sky-100 to-white",
  ...
  statCard: "p-4 rounded-full bg-linear-to-br from-blue-100 to-blue-50 shadow-sm border border-sky-100",
  ...
  searchInput: "pl-10 pr-4 py-2 rounded-full shadow-sm border border-sky-200 bg-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-200 w-full",
  ...
  tableHeader: "px-6 py-4 border-b border-sky-50 flex items-center justify-between",
  tableTitle: "text-lg font-semibold text-slate-800",
  tableCount: "text-sm text-slate-500",
  errorContainer: "px-6 py-4 border-b border-sky-50 text-sm text-rose-600",
  tableWrapper: "hidden md:block overflow-x-auto",
  table: "min-w-full divide-y divide-sky-50",
  tableHead: "bg-sky-50",
  tableHeaderCell: "px-6 py-3 text-left text-xs font-medium text-slate-600 uppercase tracking-wider",
  tableBody: "bg-white divide-y divide-sky-50",
  tableRow: "group transform transition-all duration-200 hover:shadow-lg hover:-translate-y-1",
  tableRowEven: "bg-white",
  tableRowOdd: "bg-sky-50/40",
  tableCell: "px-6 py-4 whitespace-nowrap",
  tableCellFlex: "flex items-center gap-4",
  verticalLine: "w-1 h-12 rounded-md mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-linear-to-b from-blue-400 to-sky-200",
  doctorImage: "w-12 h-12 rounded-full object-cover border-2 border-sky-100",
  ...
  mobileDoctorCard: "bg-white rounded-xl shadow p-3 border border-sky-50",
  ...
  showMoreContainer: "px-6 py-4 border-t border-sky-50 flex justify-center",
  showMoreButton: "px-4 py-2 rounded-full bg-white border border-sky-200 shadow-sm hover:bg-sky-50 transition",
...
export const addServiceStyles = {
  // Container styles
  container: {
    main: "min-h-screen font-serif bg-linear-to-br from-blue-50 via-blue-100 to-cyan-50 relative flex items-center justify-center p-4 sm:p-6 overflow-x-hidden",
    form: "w-full max-w-5xl bg-white/90 backdrop-blur-sm rounded-3xl p-6 sm:p-8 shadow-2xl border border-blue-100/50 box-border"
  },
  ...
  // Button styles
  buttons: {
    reset: "w-full sm:w-auto px-4 py-2 cursor-pointer rounded-full bg-white border border-blue-100 hover:shadow transition-shadow duration-200",
    submit: "inline-flex justify-center items-center gap-2 w-full sm:w-auto px-5 py-2 rounded-full bg-linear-to-r from-blue-500 to-cyan-500 text-white font-medium hover:shadow-lg transition-all duration-200 disabled:opacity-60",
    addInstruction: "inline-flex cursor-pointer items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 border border-blue-200 hover:bg-blue-100 transition-colors",
    uploadImage: "flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-white border border-blue-200 hover:shadow transition-shadow",
    removeImage: "px-3 py-2 rounded-full bg-white border border-red-100 hover:shadow transition-shadow",
    addSlot: "w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-linear-to-r from-blue-500 to-cyan-500 text-white font-medium hover:shadow-lg transition-all duration-200",
    ...
    container: (hasError) => 
      `w-full rounded-2xl p-4 ${
        hasError 
          ...
          : "bg-linear-to-b from-blue-50 to-cyan-50 border border-blue-100"
      } shadow-inner flex flex-col items-center gap-4`,
    preview: "w-full h-56 rounded-xl overflow-hidden bg-white flex items-center justify-center border border-blue-100",
    placeholder: "flex flex-col items-center text-blue-400"
  },
  ...
  formFields: {
    input: (hasError) => 
      `mt-2 w-full px-4 py-3 rounded-full focus:outline-none focus:ring-2 shadow-md transition-all ${
        hasError 
          ...
          : "border border-blue-100 focus:ring-blue-200"
      }`,
    textarea: (hasError) => 
    ...
    select: "mt-2 w-full px-4 py-3 rounded-full border border-blue-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-blue-200 focus:outline-none",
    smallSelect: "mt-1 w-full px-3 py-2 rounded-full border border-blue-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-blue-200 focus:outline-none",
    timeSelect: "mt-1 w-full px-2 py-2 rounded-full border border-blue-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-blue-200 focus:outline-none",
    ampmSelect: "mt-1 w-full px-1 py-2 rounded-full border border-blue-100 text-gray-700 bg-white appearance-none focus:ring-2 focus:ring-blue-200 focus:outline-none"
  },
  ...
  instructions: {
    ...
    item: "flex items-start gap-3 my-2 bg-white rounded-full p-3 border border-blue-50 shadow-sm hover:shadow transition-shadow min-w-0",
    input: "flex-1 min-w-0 px-3 py-2 rounded-full border border-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-200",
  ...
  slots: {
    container: (hasError) => 
      `bg-linear-to-br from-white to-blue-50 rounded-2xl p-4 ${
        hasError 
          ? "border-2 border-red-200" 
          : "border border-blue-50"
      } shadow-sm`,
    slotItem: "flex items-center gap-2 bg-linear-to-r from-blue-50 to-cyan-50 border border-blue-100 px-2 py-2 my-1 rounded-full shadow hover:shadow-md transition-shadow min-w-0",
  ...
  toast: {
    ...
    toastSuccess: "bg-linear-to-r from-blue-50 to-cyan-50 border-blue-100",
    iconContainer: (type) => {
      const styles = {
  ...
  // Label styles
  labels: {
    standard: "text-sm font-medium text-blue-700",
...
export const doctorListStyles = {
  container: "min-h-screen font-serif bg-blue-50 p-4 sm:p-6 md:p-8",
  ...
  headerTitle: "text-base sm:text-lg font-semibold text-blue-800",
  headerSubtitle: "text-sm sm:text-md text-blue-600",
  ...
  searchIcon: "text-blue-400",
  searchInput: "ml-3 w-full outline-none text-blue-700 placeholder-blue-400 bg-transparent",
  ...
  filterButton: (isActive, color) => {
    ...
    if (color === 'emerald') {
      return isActive
        ...
        : `${base} bg-white text-blue-700 border-blue-200`;
    } else if (color === 'red') {
      return isActive
  ...
  article: "bg-linear-to-r from-blue-100/50 to-white rounded-2xl shadow-md border border-blue-100 overflow-hidden transition-all duration-300",
  ...
  doctorName: "text-base sm:text-lg md:text-xl text-blue-800 font-medium truncate",
  ...
  doctorDetails: "text-sm text-blue-600 truncate mt-2 sm:mt-1",
  ...
  statsLabel: "text-xs text-blue-500",
  statsValue: "text-sm text-blue-700 font-medium flex items-center gap-2",
  ...
  feesLabel: "text-md font-bold text-blue-700",
  feesValue: "text-sm text-blue-800 font-medium flex items-center gap-1",
  ...
  aboutText: "text-sm text-blue-600 break-words whitespace-normal",
  
  qualificationsHeading: "text-md text-blue-700 font-bold",
  qualificationsText: "text-sm text-blue-600 break-words whitespace-normal",
  
  scheduleHeading: "text-md text-blue-700 font-bold",
  scheduleDate: "text-xs text-blue-500",
  scheduleSlot: "text-xs px-3 py-1 rounded-full border border-blue-100 shadow-sm break-words",
  ...
  showMoreButton: "px-5 py-2 cursor-pointer rounded-full bg-white border border-blue-300 shadow-sm hover:shadow-md transition",
...
export const navbarStyles = {
  ...
  logoLink: "text-3xl xl:block lg:text-xs xl:text-xl font-bold text-sky-700",
  logoSubtext: "text-xs xl:block text-gray-500",
  
  // Center navigation (desktop)
  centerNavContainer: "hidden lg:flex items-center justify-center relative",
  glowEffect: "glow relative rounded-3xl p-1 bg-linear-to-r from-blue-100 via-blue-200 to-blue-100",
  ...
  centerNavItemActive: "text-blue-400 font-semibold",
  centerNavItemInactive: "text-gray-700 hover:text-blue-600",
  
  // Right section styles
  rightContainer: "flex items-center gap-3",
  signOutButton: "hidden lg:mx-1 lg:text-xs whitespace-nowrap xl:mx-1 lg:-mr-6 xl:mr-5 lg:flex px-4 py-2 cursor-pointer rounded-full bg-indigo-500 text-white text-sm items-center gap-2 shadow-sm",
  loginButton: "px-3 py-2 cursor-pointer rounded-full border bg-white text-blue-600 text-sm shadow-sm",
  ...
  mobileSignOutButton: "w-full py-2 rounded-full border bg-indigo-500 text-white font-medium",
  mobileLoginButton: "w-full cursor-pointer py-2 rounded-full border bg-white text-blue-600 font-medium",
  
  // Indicator (for active navigation)
  indicator: "absolute bottom-0 left-0 h-0.5 bg-blue-400 transition-all duration-300 ease-out rounded-full",
  
  // Cursor utilities
  cursorPointer: "cursor-pointer",
  
  // Text colors
  textGreen700: "text-sky-700",
  ...
  borderEmerald100: "border-blue-100",
...
export const heroStyles = {
  // Container styles
  container: "min-h-screen font-sans bg-linear-to-b from-blue-50 to-white",
  ...
  // Content container
  contentBox: "bg-white/90 backdrop-blur-sm border border-blue-100 rounded-3xl shadow-xl p-8 md:p-12 text-center",
  ...
  infoCards: {
    ...
    card: "p-4 rounded-lg bg-blue-50 border border-blue-100 text-left",
...
export const serviceListStyles = {
  // Layout styles
  pageContainer: "p-4 sm:p-6 max-w-6xl font-serif mx-auto min-h-screen bg-linear-to-b from-sky-50 via-white to-white",
  
  // Header styles
  headerContainer: "flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4",
  headerTitle: "text-2xl md:text-3xl font-extrabold text-blue-700",
  headerSubtitle: "text-sm text-blue-500 mt-1",
  
  // Filter and search styles
  filterContainer: "flex flex-col md:flex-col items-stretch md:items-center gap-3 w-full md:w-auto",
  filterButtonsContainer: "inline-flex flex-wrap items-center gap-2 rounded-full border border-blue-100 bg-white p-1",
  ...
  searchInput: "pl-12 pr-4 py-2 rounded-full border border-blue-100 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-200 transition w-full md:w-72 bg-white",
  
  // Grid styles
  servicesGrid: "grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-6",
  
  // Service card styles
  serviceCard: "bg-white rounded-2xl overflow-hidden transform transition hover:-translate-y-1 hover:shadow-2xl border border-blue-50",
  serviceCardContent: "flex flex-col sm:flex-row sm:items-start gap-4 p-4 cursor-pointer",
  serviceImageContainer: "w-full sm:w-20 h-40 sm:h-20 rounded-lg overflow-hidden bg-blue-50 ring-1 ring-blue-50 flex-shrink-0",
  ...
  serviceName: "text-lg font-semibold text-blue-700 truncate",
  serviceDescription: "text-sm text-blue-500 mt-1 line-clamp-2",
  servicePriceContainer: "text-left sm:text-right mt-2 sm:mt-0",
  servicePrice: "text-md font-semibold text-blue-700",
  availabilityBadge: "text-xs mt-1 inline-flex items-center gap-1 px-2 py-1 rounded-full",
  availabilityAvailable: "bg-blue-50 text-blue-700",
  ...
  inputBase: "w-full border rounded-lg px-3 py-2 outline-none transition focus:ring-2 focus:ring-sky-200 focus:border-sky-300 border-sky-100 bg-white",
  availabilitySelectContainer: "mt-1 flex items-center gap-2",
  availabilityLabel: "text-sm text-blue-600",
  availabilitySelect: "border rounded-full cursor-pointer px-3 py-1 outline-none focus:ring-2 focus:ring-blue-200 border-blue-300",
  fileInputContainer: "mt-2",
  fileInputLabel: "text-sm block mb-1 text-blue-700",
  fileInput: "w-full border border-blue-300 rounded-full px-4 py-2 text-sm bg-white cursor-pointer file:bg-blue-50 file:border-0 file:px-4 file:py-1 file:rounded-full file:text-blue-700 hover:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-200 transition",
  textarea: "min-h-[68px]",
  ...
  addSlotButton: "inline-flex cursor-pointer items-center gap-2 text-sm px-2 py-1 rounded-full border border-blue-100",
  slotsContainer: "space-y-2 mt-2",
  slotRow: "flex flex-col sm:flex-row sm:items-center gap-2 w-full",
  slotDateInput: "border rounded-lg px-2 py-1 outline-none focus:ring-2 focus:ring-blue-200 border-blue-100 w-full sm:w-auto",
  slotTimeContainer: "flex gap-2 items-center w-full sm:w-auto",
  slotSelect: "border rounded-lg px-2 py-1 outline-none focus:ring-2 focus:ring-blue-200 border-blue-100 w-20",
  ...
  editButton: "inline-flex bg-blue-200 cursor-pointer items-center gap-2 px-3 py-2 rounded-full border border-blue-300",
  ...
  toastSuccess: "bg-white border-blue-100",
...
export const serviceAppointmentsStyles = {
  ...
  headerTitle: "text-2xl md:text-3xl font-extrabold text-blue-800",
  ...
  searchInput: "pl-10 pr-10 w-full rounded-full border border-blue-200 bg-white/90 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-200 transition-all",
  clearSearchButton: "absolute right-3 rounded-full p-1 hover:bg-gray-100",
  clearSearchIcon: "w-4 h-4 text-gray-500",
  
  statusFilterSelect: "text-sm px-3 py-2 cursor-pointer rounded-full border border-blue-400",
  ...
  loadingContainer: "col-span-full rounded-2xl p-8 bg-white/90 border border-blue-50 shadow-sm flex items-center justify-center gap-3",
  errorContainer: "col-span-full rounded-2xl p-4 bg-rose-50 border border-rose-100 text-rose-700",
  
  noResultsContainer: "col-span-full rounded-2xl p-8 bg-white/90 border border-blue-50 shadow-sm flex items-center justify-center flex-col gap-3",
  ...
  cardInner: "card-inner rounded-2xl overflow-hidden border-2 border-blue-300/60 p-5 bg-white/90 shadow-lg h-full flex flex-col justify-between",
  ...
  legendContainer: "mt-6 p-4 rounded-lg bg-white/80 shadow-inner border border-blue-100 text-sm flex flex-col sm:flex-row flex-wrap items-center gap-4",
  ...
  rescheduleButton: (terminal) => 
    `text-sm px-3 py-1 rounded-full cursor-pointer border transition ${
      terminal
        ? "bg-gray-50 text-gray-400 border-gray-200 cursor-not-allowed"
        : "bg-white text-blue-800 border-blue-400 hover:shadow-sm"
    }`,
  ...
  rescheduleDateInput: "text-sm px-3 py-1 w-full sm:w-auto text-sky-800 border border-blue-500 rounded-full",
  rescheduleTimeInput: "text-sm px-3 py-1 w-full sm:w-auto text-sky-800 border border-blue-500 rounded-full",
  rescheduleActions: "flex gap-2 w-full sm:w-auto",
  rescheduleSaveButton: "flex-1 sm:flex-none px-3 py-1 bg-sky-500 cursor-pointer text-white border-blue-500 rounded-full text-sm",
  ...
  toast: "max-w-xs w-full rounded-lg shadow-lg px-4 py-3 border-l-4 border-blue-400 bg-white/95 backdrop-blur-sm",
  toastContent: "flex items-start gap-3",
  ...
  animatedBorderStyle: `
    ...
    .animated-border::before {
      ...
      border-radius: 1rem;
      padding: 1px;
      background: linear-gradient(90deg, rgba(102,204,255,0.12), rgba(236,253,245,0.10), rgba(102,204,255,0.12));
...
export const serviceDashboardStyles = {
  // Container styles
  container: "min-h-screen font-serif p-4 sm:p-6 bg-linear-to-b from-blue-50 via-emerald-25 to-white",
  ...
  header: {
    ...
    title: "text-2xl md:text-3xl font-semibold text-blue-800",
    ...
    button: (hasServicesProp) => 
      `px-3 py-1 rounded-full text-sm ${
        hasServicesProp
          ...
          : "bg-white text-blue-600 border border-blue-200 hover:shadow-sm"
      }`
  },
  ...
  search: {
    ...
    inputContainer: "flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm border border-blue-200 w-full sm:w-64",
  ...
  table: {
    ...
    headerMd: "hidden md:grid lg:hidden grid-cols-5 items-center gap-6 px-4 py-3 text-sm text-gray-600 bg-blue-50",
    headerLg: "hidden lg:grid md:text-xs lg:text-xs xl:text-md grid-cols-12 items-center gap-4 px-4 py-3 text-sm text-gray-600 bg-blue-50",
    ...
    tabletServiceName: "text-sm font-medium text-blue-800 whitespace-nowrap",
    ...
    desktopServiceName: "font-semibold md:text-xs lg:text-lg xl:text-lg text-blue-800",
    ...
    mobileServiceName: "font-semibold text-xs text-blue-800",
  ...
  // Show more button
  showMore: {
    container: "px-6 py-4 border-t border-sky-50 flex justify-center",
    button: "px-4 py-2 rounded-full cursor-pointer bg-white border border-sky-200 shadow-sm hover:bg-sky-50 transition"
  },
  
  // StatCard component styles
  statCard: {
    container: "rounded-full bg-linear-to-br from-blue-100 to-blue-50 shadow-sm border border-sky-100 p-4 gap-4 flex items-center",
    iconContainer: "w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-700",
